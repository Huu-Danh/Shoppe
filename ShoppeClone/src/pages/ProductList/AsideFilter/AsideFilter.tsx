  ...
  return (
    <div className='py-4 ml-2'>
      <Link to={path.home} className='flex items-center font-bold'>
        <svg viewBox='0 0 12 10' className='w-3 h-4 mx-2 fill-current'>
      ...
      <ul>
        <li className='py-2 pl-2'>
          <Link to={path.home} className='relative px-2 text-orange font-semibold'>
            <svg viewBox='0 0 4 7' className='fill-orange mx-2 h-2 w-2 absolute top-1 left-[-10px]'>
      ...
      <Link to={path.home} className='flex items-center font-bold mt-4 uppercase'>
        <svg
          ...
          x={0}
          y={0}
          className='w-3 h-4 fill-current stroke-current mx-2'
        >
          <g>
            <polyline
              fill='none'
